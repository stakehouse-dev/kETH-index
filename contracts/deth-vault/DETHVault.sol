    ...
    ReentrancyGuardUpgradeable
{
    ...
    function withdrawToDETH(
        ...
        _transferDETH(_recipient, amount);
     ...
     */
    function _transferDETH(address _recipient, uint256 _dETHAmount) internal {
        ...
        _savETHWithdrawCheck(savETHAmountToWithdraw);
        ...
        _reserves[dETH] +=
            IERC20Upgradeable(dETH).balanceOf(address(this)) -
            dETHBalanceBefore;
